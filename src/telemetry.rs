...
use crate::loop_engine::TerminationReason;
...
/// How the iteration prompt was sourced.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum PromptSource {
    /// Prompt was provided inline via `--prompt-inline` or config.
    Inline,
    /// Prompt was read from a file via `--prompt-file`.
    File,
    /// No prompt was configured; provider decides behaviour.
    Absent,
    /// Prompt was generated by multi-PR triage (merge action).
    TriageMerge,
}
...
impl std::fmt::Display for PromptSource {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            PromptSource::Inline => write!(f, "inline"),
            PromptSource::File => write!(f, "file"),
            PromptSource::Absent => write!(f, "none"),
            PromptSource::TriageMerge => write!(f, "triage-merge"),
        }
    }
}
